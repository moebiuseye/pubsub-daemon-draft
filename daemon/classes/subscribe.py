...
class SubscribeClient(PubsubClient):
    """  """
    
    def __init__(self, jid='pub_sub@moeyeb.us/script_subscribe', password='pubsub'):
        """ Function doc
    
        @param PARAM: DESCRIPTION
        @return RETURN: DESCRIPTION
        """
        super(SubscribeClient, self).__init__(jid=jid, password=password)
    ...
    def do_it(self):
        ...
        #try:
        logging.warn("====================================================")
        logging.warn("self.do_it() with args : server=%r node=%r action=%r data=%r" % (self.pubsub_server, self.node, self.action, self.data) )
